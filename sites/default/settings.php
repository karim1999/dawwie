 ...
 * @endcode
 */
$settings['hash_salt'] = 'adasdasdasdassadasd';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_dawwie_dd.inc')) {
    require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_dawwie_dd.inc';
}
// </DDSETTINGS>

  $databases['default']['default'] = [
    'database' => 'dawwieco_dawwie',
    'username' => 'root',
    'password' => '',
    'host' => 'localhost',
    'port' => '3306',
